...
!function (e, t) {
  ...
  function (e) {
      ...
      if (!i && ((t ? t.ownerDocument || t : w) !== d && p(t), t = t || d, g)) {
        ...
        if (n.qsa && !S[e + " "] && (!v || !v.test(e))) {
          if (1 !== T) m = t, y = e;else if ("object" !== t.nodeName.toLowerCase()) {
            for ((c = t.getAttribute("id")) ? c = c.replace(ne, re) : t.setAttribute("id", c = b), s = (h = a(e)).length; s--;) {
              h[s] = "#" + c + " " + me(h[s]);
            }
    ...
    for (t in n = ae.support = {}, o = ae.isXML = function (e) {
      ...
      pseudos: {
        ...
        lang: ue(function (e) {
          return V.test(e || "") || ae.error("unsupported lang: " + e), e = e.replace(ee, te).toLowerCase(), function (t) {
            var n;
    ...
    function Te(e, t, n, r, i, o) {
      return r && !r[b] && (r = Te(r)), i && !i[b] && (i = Te(i, o)), ue(function (o, a, s, u) {
        ...
        if (n && n(v, y, s, u), r) for (l = we(y, d), r(l, [], s, u), c = l.length; c--;) {
          (f = l[c]) && (y[d[c]] = !(v[d[c]] = f));
        }
    ...
    function Ce(e) {
      for (var t, n, i, o = e.length, a = r.relative[e[0].type], s = a || r.relative[" "], u = a ? 1 : 0, c = xe(function (e) {
        ...
        if (n = r.relative[e[u].type]) p = [xe(be(p), n)];else {
        ...
        s = S(e, function (e, t) {
          var n = t.length > 0,
            ...
            if (y += m, n && m !== y) {
              ...
              L.apply(u, b), c && !_o && b.length > 0 && y + t.length > 1 && ae.uniqueSort(u);
            }
            ...
            return function () {
              var s = this,
                ...
                if (!(t < o)) {
                  ...
                  l = e && ("object" == _typeof(e) || "function" == typeof e) && e.then, g(l) ? i ? l.call(e, a(o, n, R, i), a(o, n, I, i)) : (o++, l.call(e, a(o, n, R, i), a(o, n, I, i), a(o, n, R, n.notifyWith))) : (r !== R && (s = void 0, u = [e]), (i || n.resolveWith)(s, u));
                }
              },
                  c = i ? l : function () {
                try {
    ...
    data: function data(e, t) {
      ...
      if (void 0 === e) {
        if (this.length && (i = K.get(o), 1 === o.nodeType && !J.get(o, "hasDataAttrs"))) {
          for (n = a.length; n--;) {
            a[n] && 0 === (r = a[n].name).indexOf("data-") && (r = G(r.slice(5)), te(o, r, i[r]));
          }
  ...
  function be(e, t, n, r, i) {
    for (var o, a, s, u, l, c, f = t.createDocumentFragment(), p = [], d = 0, h = e.length; d < h; d++) {
      if ((o = e[d]) || 0 === o) if ("object" === x(o)) w.merge(p, o.nodeType ? [o] : o);else if (xe.test(o)) {
        for (a = a || f.appendChild(t.createElement("div")), s = (pe.exec(o) || ["", ""])[1].toLowerCase(), u = he[s] || he._default, a.innerHTML = u[1] + w.htmlPrefilter(o) + u[2], c = u[0]; c--;) {
          a = a.lastChild;
        }
    ...
    for (f.textContent = "", d = 0; o = p[d++];) {
      if (r && w.inArray(o, r) > -1) i && i.push(o);else if (l = w.contains(o.ownerDocument, o), a = ge(f.appendChild(o), "script"), l && ve(a), n) for (c = 0; o = a[c++];) {
  ...
  w.event = {
    ...
    add: function add(e, t, n, r, i) {
      var o,
          ...
          g,
          v = J.get(e);
      if (v) for (n.handler && (n = (o = n).handler, i = o.selector), i && w.find.matchesSelector(we, i), n.guid || (n.guid = w.guid++), (u = v.events) || (u = v.events = {}), (a = v.handle) || (a = v.handle = function (t) {
        return void 0 !== w && w.event.triggered !== t.type ? w.event.dispatch.apply(e, arguments) : void 0;
      }), l = (t = (t || "").match(M) || [""]).length; l--;) {
        d = g = (s = Ee.exec(t[l]) || [])[1], h = (s[2] || "").split(".").sort(), d && (f = w.event.special[d] || {}, d = (i ? f.delegateType : f.bindType) || d, f = w.event.special[d] || {}, c = w.extend({
          type: d,
          origType: g,
          data: r,
          handler: n,
      ...
      if (s.delegateTarget = this, !c.preDispatch || !1 !== c.preDispatch.call(this, s)) {
        for (a = w.event.handlers.call(this, s, l), t = 0; (i = a[t++]) && !s.isPropagationStopped();) {
          for (s.currentTarget = i.elem, n = 0; (o = i.handlers[n++]) && !s.isImmediatePropagationStopped();) {
            s.rnamespace && !s.rnamespace.test(o.namespace) || (s.handleObj = o, s.data = o.data, void 0 !== (r = ((w.event.special[o.origType] || {}).handle || o.handler).apply(i.elem, u)) && !1 === (s.result = r) && (s.preventDefault(), s.stopPropagation()));
          }
        }
  ...
  function Ie(e, t, n, r) {
    ...
    if (p && (o = (i = be(t, e[0].ownerDocument, !1, e, r)).firstChild, 1 === i.childNodes.length && (i = o), o || r)) {
      for (u = (s = w.map(ge(i, "script"), Oe)).length; f < p; f++) {
        l = i, f !== d && (l = w.clone(l, !0, !0), u && w.merge(s, ge(l, "script"))), n.call(e[f], l, f);
      }

      if (u) for (c = s[s.length - 1].ownerDocument, w.map(s, Pe), f = 0; f < u; f++) {
        l = s[f], de.test(l.type || "") && !J.access(l, "globalEval") && w.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? w._evalUrl && w._evalUrl(l.src) : m(l.textContent.replace(Le, ""), c, l));
      }
    }
  ...
  function $e(e, t, n) {
    for (var r, i = t ? w.filter(t, e) : e, o = 0; null != (r = i[o]); o++) {
      n || 1 !== r.nodeType || w.cleanData(ge(r)), r.parentNode && (n && w.contains(r.ownerDocument, r) && ve(ge(r, "script")), r.parentNode.removeChild(r));
    }
  ...
  w.extend({
    ...
    clone: function clone(e, t, n) {
      ...
      if (!(h.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || w.isXMLDoc(e))) for (a = ge(s), r = 0, i = (o = ge(e)).length; r < i; r++) {
        Re(o[r], a[r]);
      }
      if (t) if (n) for (o = o || ge(e), a = a || ge(s), r = 0, i = o.length; r < i; r++) {
        Me(o[r], a[r]);
      } else Me(e, s);
  ...
  function Ze(e, t, n, r, i, o) {
    ...
    for (; a < 4; a += 2) {
      "margin" === n && (u += w.css(e, n + ie[a], !0, i)), r ? ("content" === n && (u -= w.css(e, "padding" + ie[a], !0, i)), "margin" !== n && (u -= w.css(e, "border" + ie[a] + "Width", !0, i))) : (u += w.css(e, "padding" + ie[a], !0, i), "padding" !== n ? u += w.css(e, "border" + ie[a] + "Width", !0, i) : s += w.css(e, "border" + ie[a] + "Width", !0, i));
    }
  ...
  w.extend({
    ...
    style: function style(e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        ...
        "string" === (o = _typeof(n)) && (i = re.exec(n)) && i[1] && (n = se(e, t, i), o = "number"), null != n && n == n && ("number" === o && (n += i && i[3] || (w.cssNumber[s] ? "" : "px")), h.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), a && "set" in a && void 0 === (n = a.set(e, n, r)) || (u ? l.setProperty(t, n) : l[t] = n));
      }
    },
  ...
  function ct(e, t, n) {
    ...
    for (!function (e, t) {
      ...
      for (n in e) {
        if (i = t[r = G(n)], o = e[n], Array.isArray(o) && (i = o[1], o = e[n] = o[0]), n !== r && (e[r] = o, delete e[n]), (a = w.cssHooks[r]) && ("expand" in a)) for (n in o = a.expand(o), delete e[r], o) {
  ...
  w.Animation = w.extend(ct, {
    ...
    prefilters: [function (e, t, n) {
      ...
      if ((u = !w.isEmptyObject(t)) || !w.isEmptyObject(d)) for (r in f && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], null == (l = v && v.display) && (l = J.get(e, "display")), "none" === (c = w.css(e, "display")) && (l ? c = l : (ce([e], !0), l = e.style.display || l, c = w.css(e, "display"), ce([e]))), ("inline" === c || "inline-block" === c && null != l) && "none" === w.css(e, "float") && (u || (p.done(function () {
        h.display = l;
  ...
  w.fn.extend({
    ...
    toggleClass: function toggleClass(e, t) {
      ...
      return "boolean" == typeof t && r ? t ? this.addClass(e) : this.removeClass(e) : g(e) ? this.each(function (n) {
        ...
        var t, i, o, a;
        if (r) for (i = 0, o = w(this), a = yt(e); t = a[i++];) {
  ...
  w.extend(w.event, {
    trigger: function trigger(t, n, i, o) {
      ...
      if (s = h = u = i = i || r, 3 !== i.nodeType && 8 !== i.nodeType && !xt.test(m + w.event.triggered) && (m.indexOf(".") > -1 && (x = m.split("."), m = x.shift(), x.sort()), c = m.indexOf(":") < 0 && "on" + m, (t = t[w.expando] ? t : new w.Event(m, "object" == _typeof(t) && t)).isTrigger = o ? 2 : 3, t.namespace = x.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + x.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : w.makeArray(n, [t]), d = w.event.special[m] || {}, o || !d.trigger || !1 !== d.trigger.apply(i, n))) {
        if (!o && !d.noBubble && !v(i)) {
          for (l = d.delegateType || m, xt.test(l + m) || (s = s.parentNode); s; s = s.parentNode) {
            y.push(s), u = s;
          }
  ...
  w.ajaxSetup({
    ...
    var r,
        ...
        a = this,
        s = e.indexOf(" ");
    return s > -1 && (r = gt(e.slice(s)), e = e.slice(0, s)), g(t) ? (n = t, t = void 0) : t && "object" == _typeof(t) && (i = "POST"), a.length > 0 && w.ajax({
      url: e,
      type: i || "GET",
      dataType: "html",
      data: t
